...
public class TypeVisitorImpl implements TypeVisitor {
	...
	public Type visit(MethodDecl methodDecl) {
		...
		currentMethod = currentClass.getMethod(methodDecl.methodNameId
				.toString());
	...
	public Type visit(Call callStmt) {
		...
		MethodDescriptor method = symbolTable.getMethod(methodName,
				classNameStr);
	...
	public Type visit(Identifier id) {
		Type t = symbolTable.getVarType(currentMethod, currentClass,
				id.toString());
		id.setType(t);
		return t;
	}
