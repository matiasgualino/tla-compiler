...
public class JasminHelper {
   ...
   public static Entry<String, String> executeMainMethod(Method m) {
    ...
    //Lädt alle Klassen mit dem Class-Loader und führt alle Main-Methoden
    //aus, die gefunden werden. Gibt dann eine Map zurück, die jeder Klasse
    //das Ergebniss der Main-Methode zuordnet
